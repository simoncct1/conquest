...
<html lang="en">
  ...
  <body>
    <div id="content">
    <div class="one"><a href="map.php"><img  src="sources/map.png" alt=""></a></div>
      <div class="two"><a href="cesp.html"><img  src="sources/c.esp.png" alt=""></a></div>
      <div class="three" id="three"><a href="budget.html"><img  src="sources/bud.png" alt=""></a></div>
      <div class="four" id="MS"><img  src="sources/ms.png" alt=""></div>
      <div class="five" id="DB"><img  src="sources/db.png" alt=""></div>
      <div id="params">
 ...
 <div id="interface"> <a href="index.html">X</a></div>
 <div id="changes"><input id="1" type="button" value="Forage"><input id="2"  type="button" value="Topographie"><input  id="3"  type="button" value="Occupation"></div>
